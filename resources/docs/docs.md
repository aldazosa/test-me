...
The `home-routes` handler in the `test-me.routes.home` namespace
...
The `home-page` function will in turn call the `test-me.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/test_me/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `test-me.handler` namespace:
...
Request middleware functions are located under the `test-me.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `test-me.dev-middleware` namespace found in
